...
@EnableJpaRepositories(
        ...
        basePackages = {"telefonica.aaee.marte.acuerdos"}
        )
@ComponentScan("telefonica.aaee.marte.acuerdos") //Specifies which package to scan
...
public class JPAAcuerdosConfig 
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() 
        ...
        em.setPackagesToScan("telefonica.aaee.marte.acuerdos");
