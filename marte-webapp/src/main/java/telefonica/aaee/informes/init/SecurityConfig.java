...
import telefonica.aaee.informes.process.MailUtil;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/role/**")
				.access("hasRole('ROLE_ADMIN')").antMatchers("/usuario/**")
				.access("hasRole('ROLE_ADMIN')").antMatchers("/consulta/**")
				.access("hasRole('ROLE_ADMIN')").antMatchers("/pestanya/**")
				.access("hasRole('ROLE_ADMIN')").antMatchers("/informe/**")
				.access("hasRole('ROLE_ADMIN')").antMatchers("/regladenegocio/**")
