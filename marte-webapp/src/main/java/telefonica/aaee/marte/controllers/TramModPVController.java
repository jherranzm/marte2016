...
import telefonica.aaee.marte.form.TramitacionModPVForm;
...
@Controller
@RequestMapping("/tram/modpv")
public class TramModPVController extends BasicController {
	
	private HashMap<CuentaCorriente, Date> cuentas = new HashMap<CuentaCorriente, Date>();

	private static final String TRAM_MOD_PV_FORM = "html/findcif/tram-mod-pv-form";
	private static final String TRAM_MOD_PV_CONF = "html/findcif/tram-mod-pv-conf";
	...
	public ModelAndView showFormModPVAcuerdo(
			@ModelAttribute TramitacionModPVForm form,
		...
		modelAndView.setViewName(TRAM_MOD_PV_FORM);
	...
	public ModelAndView tramModCOAcuerdoConf(
		...
		modelAndView.setViewName(TRAM_MOD_PV_CONF);
		modelAndView.addObject("tramModPVForm", form);
		modelAndView.addObject("acuerdo", acuerdo);
		return modelAndView;
	}
	...
	public ModelAndView tramModCOAcuerdoConfirmada(
		...
		sbPeticionTramitacion
			.append("Cambio a Pago por Ventanilla.").append(Constantes.CRLF)
			.append("PV:").append(ccc).append(Constantes.CRLF)
