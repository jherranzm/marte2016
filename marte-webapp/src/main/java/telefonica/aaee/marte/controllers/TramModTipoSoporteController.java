...
import telefonica.aaee.marte.form.TramitacionModTipoSoporteForm;
import telefonica.aaee.marte.model.pagination.PageWrapper;
import telefonica.aaee.util.Constantes;
import eu.bitwalker.useragentutils.UserAgent;

@Controller
@RequestMapping("/tram/modtiposoporte")
public class TramModTipoSoporteController extends BasicController {

	private static final String TRAM_MOD_TIPOSOPORTE_FORM = "html/findcif/tram-mod-tiposoporte-form";
	private static final String TRAM_MOD_TIPOSOPORTE_CONF = "html/findcif/tram-mod-tiposoporte-conf";
	...
	public ModelAndView showFormModTipoSoporteAcuerdo(
			@ModelAttribute TramitacionModTipoSoporteForm form,
		...
		modelAndView.setViewName(TRAM_MOD_TIPOSOPORTE_FORM);
		
		if(form == null){
			form = new TramitacionModTipoSoporteForm();
			form.setIdAcuerdo(acuerdo.getIDAcuerdo());
	
		}
		logger.info(String.format("[%s]", form.toString()));
		modelAndView.addObject("tramModTipoSoporteForm", form);
	...
	public ModelAndView tramModTipoSoporteAcuerdoForm(
			@ModelAttribute TramitacionModTipoSoporteForm form,
			HttpServletRequest request,  
	...
	public ModelAndView tramModTipoSoporteAcuerdoConf(
			@ModelAttribute TramitacionModTipoSoporteForm form,
			HttpServletRequest request,  
			final RedirectAttributes redirectAttributes, 
			Authentication auth,
		...
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName(TRAM_MOD_TIPOSOPORTE_CONF);
		modelAndView.addObject("tramModTipoSoporteForm", form);
		modelAndView.addObject("acuerdo", acuerdo);
		return modelAndView;
	}
	...
	public ModelAndView tramModTipoSoporteAcuerdoConfirmada(
			@ModelAttribute TramitacionModTipoSoporteForm form,
			HttpServletRequest request,  
			final RedirectAttributes redirectAttributes, 
			Authentication auth,
		...
		CodAPI codAPI = codAPIService.findById("Soporte");
		...
		tramAPI.setEmail(form.getEmail());
		...
		sbPeticionTramitacion
			.append("Modificación de Tipo Soporte: INTERNET.").append(Constantes.CRLF)
			.append("================================").append(Constantes.CRLF)
			.append(Constantes.CRLF);		
		if(!"".equals(form.getEmail())){
			sbPeticionTramitacion
				.append("e-mail:").append(form.getEmail()).append(Constantes.CRLF);
		}
