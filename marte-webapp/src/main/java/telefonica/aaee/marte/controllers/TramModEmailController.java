...
import telefonica.aaee.marte.form.TramitacionModEmailForm;
import telefonica.aaee.marte.model.pagination.PageWrapper;
import telefonica.aaee.util.Constantes;
import eu.bitwalker.useragentutils.UserAgent;

@Controller
@RequestMapping("/tram/modemail")
public class TramModEmailController extends BasicController {

	private static final String TRAM_MOD_EMAIL_FORM = "html/findcif/tram-mod-email-form";
	private static final String TRAM_MOD_EMAIL_CONF = "html/findcif/tram-mod-email-conf";
	...
	public ModelAndView showFormModEmailAcuerdo(
			@ModelAttribute TramitacionModEmailForm form,
		...
		modelAndView.setViewName(TRAM_MOD_EMAIL_FORM);
		
		if(form == null){
			form = new TramitacionModEmailForm();
			form.setIdAcuerdo(acuerdo.getIDAcuerdo());
	
		}
		logger.info(String.format("[%s]", form.toString()));
		modelAndView.addObject("tramModEmailForm", form);
	...
	public ModelAndView tramModEmailAcuerdoForm(
			@ModelAttribute TramitacionModEmailForm form,
			HttpServletRequest request,  
	...
	public ModelAndView tramModEmailAcuerdoConf(
			@ModelAttribute TramitacionModEmailForm form,
			HttpServletRequest request,  
			final RedirectAttributes redirectAttributes, 
			Authentication auth,
		...
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName(TRAM_MOD_EMAIL_CONF);
		modelAndView.addObject("tramModEmailForm", form);
		modelAndView.addObject("acuerdo", acuerdo);
		return modelAndView;
	}
	...
	public ModelAndView tramModEmailAcuerdoConfirmada(
			@ModelAttribute TramitacionModEmailForm form,
			HttpServletRequest request,  
			final RedirectAttributes redirectAttributes, 
			Authentication auth,
		...
		sbPeticionTramitacion
			.append("Modificación dirección de email.").append(Constantes.CRLF)
