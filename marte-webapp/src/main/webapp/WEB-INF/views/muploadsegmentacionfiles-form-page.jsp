...
<title><spring:message text="missing" code="muploadsegmentacion.form.title.text" /></title>
...
<body>
	...
	<div id="wrap">
		...
		<div class="container">
			...
			<div id="segmentacion-form" class="panel panel-primary">

				<div id="segmentacion-form-titulo" class="panel-heading">
					<h3 class="panel-title">
					<spring:message text="missing" code="muploadsegmentacion.form.title.text" />
					</h3>
				</div>
	
				<div id="formulario" class="panel-body">
					<form:form method="post"
						id="uploadMultipleSegmentacionFilesForm"
						action="${pageContext.request.contextPath}/segmentacion?${_csrf.parameterName}=${_csrf.token}"
						...
						<input 
							...
							value="<spring:message text="missing" code="muploadsegmentacion.form.btn.upload.text" />" />
...
<script type="text/javascript">
	$(function() {
		...
		var form = $("#uploadMultipleSegmentacionFilesForm");
		form.on('submit', function(e){
			...
			$.ajax({
				...
				beforeSend : function() {
					...
					var p_info = $('<p></p>');
					p_info.text('Cargando y procesando fichero(s) Segmentación...');
