...
<title><spring:message text="missing" code="muploadcargaprefijos.form.title.text" /></title>
...
<body>
	...
	<div id="wrap">
		...
		<div class="container">
			...
			<div id="cargaprefijos-form" class="panel panel-primary">
	
				<div class="panel-heading">
					<h3 class="panel-title">
						<spring:message text="missing" code="muploadcargaprefijos.form.title.text" />
					</h3>
				</div>
	
				<div class="panel-body" id="formulario">
					<form:form method="post"
						id="uploadMultipleCargaPrefijosFilesForm"
						action="${pageContext.request.contextPath}/cargaprefijos?${_csrf.parameterName}=${_csrf.token}"
						modelAttribute="uploadForm" 
						enctype="multipart/form-data">
		
						<p class="bg-info webapp-margin">
							<spring:message text="missing" code="muploadcargaprefijos.form.info.text" />
						</p>
						...
						<input 
							...
							value="<spring:message text="missing" code="muploadcargaprefijos.form.btn.upload.text" />" />
...
<script type="text/javascript">
	$(function() {
		...
		var form = $("#uploadMultipleCargaPrefijosFilesForm");
		form.on('submit', function(e){
			...
			$.ajax({
				...
				beforeSend : function() {
					...
					var p_info = $('<p></p>');
					p_info.text('Cargando y procesando fichero(s) de Carga de Prefijos Internacional...');
