...
<title><spring:message text="missing" code="muploadsegmentacion.success.title.text" /></title>
	...
	<div id="wrap">
		...
		<div class="container">
			...
			<div class="page-header">
				<h1>
					<spring:message text="missing" code="muploadsegmentacion.success.title.text" />
				</h1>
			</div><!-- .page-header -->
