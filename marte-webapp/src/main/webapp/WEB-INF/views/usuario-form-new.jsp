...
<head>
	...
	<title><spring:message text="missing" code="usuario.form.new.title" /></title>
		...
		<div id="usuario-form" class="panel panel-primary">
	        ...
	        <div id="usuario-form-contenido"><!-- inicio contenido -->
				<form:form 
					id="usuario-form-new" 
					method="POST" 
					commandName="usuarioForm"
					class="form-horizontal"
					action="${pageContext.request.contextPath}/usuario/save.html">
					...
					<div class="form-group">
						<label for="password1" class="col-sm-2 control-label">
							<spring:message code="usuario.form.field.password" />
						</label>
						<div class="col-sm-8">
							<input id="password1" name="password1" type="password" 
							class="form-control" placeholder="${usuarioForm.password1}" value="${usuarioForm.password1}">
						</div> 
					</div>
		
					<div class="form-group">
						<label for="password2" class="col-sm-2 control-label">
							<spring:message code="usuario.form.field.retypepassword" />
						</label>
						<div class="col-sm-8">
							<input id="password2" name="password2" type="password" 
							class="form-control" placeholder="${usuarioForm.password2}" value="${usuarioForm.password2}">
						</div> 
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<form:checkboxes items="${rolesDisponibles}" 
												path="roles"
												itemValue="id"
												itemLabel="nombre" 
												delimiter="<br/>"
