		...
		<div class="panel panel-primary">
	        ...
	        <div><!-- inicio contenido -->
				<form:form method="POST" commandName="pestanyaForm"
					...
					<div class="form-group">
						<label for="rango" class="col-sm-2 control-label">
					...
					<div class="form-group">
						<label for="consultaSQL_id" class="col-sm-2 control-label">
					...
					<div class="form-group">
						<label for="numFilaInicial" class="col-sm-2 control-label">
