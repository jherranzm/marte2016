...
<head>
	...
	<title><spring:message text="missing" code="pestanya.form.edit.title" /></title>
		...
		<div class="panel panel-primary">
 	       ...
 	       <div class="panel-heading">
	          <h3 class="panel-title">
					<spring:message text="missing" code="pestanya.form.edit.title" />
					${pestanyaForm.id}
	          </h3>
 	       </div>
        
 	       <div class="well">
			<a href="${pageContext.request.contextPath}/pestanya/dup/${pestanyaForm.id}"
				id="btn-back" class="btn btn-primary">
				<span class="glyphicon glyphicon-duplicate" aria-hidden="true"></span> 
				<span><spring:message text="missing" code="pestanya.form.btn.duplicate" /></span>
			</a>
 	       </div>
