...
<body>
	...
	<div class="container">
		...
		<div id="consulta-form" class="panel panel-primary">
 	       ...
 	       <div class="well">
			<a href="${pageContext.request.contextPath}/consulta/dup/${consulta.id}"
				id="btn-back" class="btn btn-primary">
				<span class="glyphicon glyphicon-duplicate" aria-hidden="true"></span> 
				<span><spring:message text="missing" code="consulta.form.btn.duplicate" /></span>
			</a>
 	       </div>
	        ...
	        <div id="consulta-form-contenido"><!-- inicio contenido -->
				<form:form method="POST" commandName="consulta"
					...
					<div class="form-group">
						<label for="definicion" class="col-sm-2 control-label">
